...
<div class="bs-component">
  ...
  <code>
    @include helsinki-logo($black);<br/>
    height: $line-height-computed * 4;
  </code>
</div>

<div class="bs-component">
  <div class="logo-test logo-test--copper">
  </div>
  <code>
  @include helsinki-logo($hel-copper);<br/>
  height: $line-height-computed * 3;
  </code>
</div>

<div class="bs-component">
  <div class="logo-test logo-test--bus">
  </div>
  <code>
    @include helsinki-logo($hel-bus);<br/>
...
-----
<div class="bs-component">
  <div class="partition-test basic-bus-300">
    <h3>Basic</h3>
    <code>@include koro("basic",$hel-bus, 300);</code>
  </div>
</div>
<div class="bs-component">
  <div class="partition-test pulse-bus-300">
    <h3>Pulse</h3>
    <code>@include koro("pulse",$hel-bus, 300);</code>
  </div>
</div>
<div class="bs-component">
  <div class="partition-test beat-bus-300">
    <h3>Beat</h3>
    <code>@include koro("beat",$hel-bus, 300);</code>
  </div>
</div>
<div class="bs-component">
  <div class="partition-test storm-bus-300">
    <h3>Storm</h3>
    <code>@include koro("storm",$hel-bus, 300);</code>
  </div>
</div>
<div class="bs-component">
  <div class="partition-test wave-bus-300">
    <h3>Wave</h3>
    <code>@include koro("wave",$hel-bus, 300);</code>
  </div>
</div>

### Koro scale and color examples
There are five different shapes. Basic, Pulse, Beat, Storm and Wave.

<div class="bs-component">
  <div class="partition-test beat-copper-100">
    <h3>Beat Copper 100%</h3>
    <code>@include koro("beat",$hel-copper, 100);</code>
  </div>
</div>
<div class="bs-component">
  <div class="partition-test beat-suomenlinna-500">
    <h3>Beat Suomenlinna 500%</h3>
    <code>@include koro("beat",$hel-suomenlinna, 500);</code>
  </div>
</div>
<div class="bs-component">
  <div class="partition-test storm-tram-250">
    <h3>Storm Tram 250%</h3>
    <code>@include koro("storm",$hel-tram, 250);</code>
  </div>
</div>
<div class="bs-component">
  <div class="partition-test storm-engel-400">
    <h3>Storm Engel 400%</h3>
    <code>@include koro("storm",$hel-engel, 400);</code>
  </div>
</div>
-----
